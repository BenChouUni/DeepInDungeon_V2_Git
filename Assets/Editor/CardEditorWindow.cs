    ...
    public void OnGUI()
    {
        ...
        HorizontalGroup(() =>
        {
            ...
            VerticalGroup(() =>
            {
                ...
                EditorGUILayout.LabelField("Card List: ",GUILayout.Width(divineWidth-20));
               
                edittingCardSO = (CardSO)EditorGUILayout.ObjectField(edittingCardSO, typeof(CardSO), false,GUILayout.Width(divineWidth - 25));
