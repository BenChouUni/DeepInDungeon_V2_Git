...
public class ActionManager : MonoSingleton<ActionManager>
{
    ...
    //    CharaterType target = action.target;
    //    StateEffect statusEffect = EffectFactory.GetStatusEffect(action.StatusEffect);
    ...
    ////給予狀態
    //private void GiveAction(CharaterType targetType, int parameter,StateEffect statusEffect)
    //{
    ...
    //    List<StateEffect> effects = StatusEffectManager.instance.GetTargetEffectList(character.targetType);
    //    //根據效果執行傷害增幅
    //    foreach (StateEffect item in effects)
    //    {
    ...
    //{
    //    Debug.LogFormat("{1}回{0}血", num,character.CharacterName);
    //    character.HpState.RestoreHp(num);
    //}
    ...
    //    Debug.LogFormat("{0}獲得{1}護盾", character.CharacterName, shield);
    //    character.AddShield(shield);
    //}

    //private Character GetCharacter(CharaterType type)
    //{
    ...
    //    CardActionBase action = new CardActionBase(ActionType.WeaponAttack, dmg, CharaterType.Enemy);
    //    DoAction(action);
    ...
    //    CardActionBase action = new CardActionBase(ActionType.WeaponDefend, def, CharaterType.Player);
    //    DoAction(action);
    ...
    //    CardActionBase action = new CardActionBase(ActionType.RealDefend, def, CharaterType.Enemy);
    //    DoAction(action);
    //    EnemyManager.instance.UpdateEnemyStatus();
    //}
    #endregion
